...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('El varadero') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('img/new_logo.png')}}">
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <!-- src="{{ asset('material') }}/js/plugins/jquery.dataTables.min.js"></script -->
